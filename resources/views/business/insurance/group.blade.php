...
@section('title', 'Group Life Insurance – AYA Bank')
...
<div class="layout-wrapper layout-content-navbar">
   	<div class="layout-container">
		<div class="layout-page">
			...
			@include('layouts.banner', ['page'=>'bu_group_life_insurance'])
					...
					<div class="tab-content" style="background-color: transparent;padding: 30px 0px 0px 0px;">
						<div class="tab-pane fade show active" id="navs-pills-top-key_spec" role="tabpanel" style="background: transparent;padding-bottom: 30px;">
							<div class="container section_1">
								<div class="row">
									<div class="col-md-6">
										<p class="theme_text_color fw-semibold" style="margin-bottom: 5px;">Insurable Age</p>
										<p>Employee aged 18 years to 65 years old</p>
									</div>
									<div class="col-md-6">
										<p class="theme_text_color fw-semibold" style="margin-bottom: 5px;">Premium Rate</p>
										<p>1% of Sum Assured amount</p>
									</div>
									<div class="col-md-6">
										<p class="theme_text_color fw-semibold" style="margin-bottom: 5px;">Sum Assured</p>
										<p>Starting from MMK ten thousand</p>
									</div>
								</div>
									...
									<div class="col-md-10">
										<div class="row">
											...
											<div class="col-11 list_margin">
												<p class="fw-semibold mb-0">Death Benefit</p>
												<p>Sum assured paid to the beneficiary in the event of unfortunate death of insured</p>
											</div>
											<div class="col-1">
												<i class="menu-icon tf-icons bx bx-check secure_req_application_icon"></i>
											</div>
											<div class="col-11 list_margin">
												<p class="fw-semibold mb-0">Total Permanent Disability Benefit </p>
												<p>Sum assured paid to insured in the event of permanent disability</p>
											</div>
											<div class="col-1">
												<i class="menu-icon tf-icons bx bx-check secure_req_application_icon"></i>
											</div>
											<div class="col-11 list_margin">
												<p class="fw-semibold mb-0">Injury Benefit</p>
												<p>Financial Support if the employee suffers an injury</p>
											</div>
										</div>
									</div>
								</div>
