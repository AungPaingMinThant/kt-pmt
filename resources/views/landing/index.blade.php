		...
		<div class="layout-page">
								...
								<div class="row app_detail_div">
									...
									<div class="col-md-10">
										<a href="http://bit.ly/ayambankingios">
											<img src="{{ url('/images/apple.png') }}" class="img-fluid" style="width: 30%;margin-right: 20px;">
										</a>
										<a href="http://bit.ly/ayambankingandriod">
											<img src="{{ url('/images/google.png') }}" class="img-fluid" style="width: 35%">
										</a>
									</div>
								</div>
							</div>
				...
				<div class="container section_1">
					<div class="row">
						...
						<div class="col-md-6" style="position: relative;">
							<div class="row CTA_section_1_info">
								<p class="CTA_desc">Match your needs with our comprehensive personal borrowing plan</p>
			...
			<div class="CTA_section_2">
				<div class="container section_1">
					<div class="row">
						<div class="col-md-6" style="position: relative;">
							<div class="row CTA_section_2_info">
								<p class="CTA_desc">Let us guide you what you are looking for your business</p>
								<div class="input-group">
			...
			<div class="CTA_section_3">
				<div class="container section_1">
					<div class="row">
						<div class="col-md-6"></div>
						<div class="col-md-6" style="position: relative;">
							<div class="row CTA_section_3_info">
								<p class="CTA_desc">Find the insurance you need</p>
								<div class="input-group">
									<label class="input-group-text" for="inputGroupSelect03">I want to &nbsp;</label>
									<select class="form-select" id="inputGroupSelect03">
										<option value="0" selected>get whole life protection and savings
										<option value="1">protect my life and save my future
										<option value="2">drive vehicle with peace of mind
										<option value="3">care for health and save money
										<option value="4">get coverage for safe traveling
										<option value="5">get potection for my business
									</select>
								</div>
							</div>
						</div>
				...
				<div class="row">
					...
					<div class="col-md-6">
						...
						<div class="row view_all_news">
							...
							<div class="col-md-6 text-center" style="display: table;">
...
<script type="text/javascript">
	...
	// var timer = setInterval(changeCTA1, 3000);
