				...
				<div class="row">
					...
					<div class="col-md-8 col-sm-12">
						<ul class="safety_tip_1" style="list-style: disc;">
							...
							<li>In touh with your bank account - Use <a href="{{ url('/sms-alert') }}" style="color: #a02226;text-decoration: underline;">SMS Alert</a> to keep track of what is happening on your account.</li>
