		...
		<div class="layout-page">
			...
			<div class="" style="background-image: url('./images/premium-banking/bg.jpg');background-size: cover;background-repeat: no-repeat;">
				<div class="container section_1">
					...
					<div class="row" style="background-image: url('./images/premium-banking/intro-bg.jpg');background-size: cover;background-repeat: no-repeat;">
						<div class="col-md-12 text-center" style="padding: 20px 40px;">
							<p style="font-weight: 500;color: #fff;margin-bottom: 30px;font-size: 30px;">Sail on a journey of excellence with exclusive privileges offered by AYA Royal Banking</p>
