                                ...
                                <div class="col-md-4 cat_card">
                                    <div class="card h-100">
                                        ...
                                        <div class="card-body">
                                            ...
                                            <a href="{{ url('/about-aya/sustainability/our-approach/social-sustainability') }}" class="view_bio_link theme_text_color">Learn More <i class='bx bx-chevron-right' style="font-size: 18px;"></i></a>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-md-4 cat_card">
                                    <div class="card h-100">
                                        ...
                                        <div class="card-body">
                                            ...
                                            <a href="{{ url('/about-aya/career/aya-culture') }}" class="view_bio_link theme_text_color">Learn More <i class='bx bx-chevron-right' style="font-size: 18px;"></i></a>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-md-4 cat_card">
                                    <div class="card h-100">
                                        ...
                                        <div class="card-body">
                                            ...
                                            <a href="{{ url('/about-aya/career/life-at-aya') }}" class="view_bio_link theme_text_color">Learn More <i class='bx bx-chevron-right' style="font-size: 18px;"></i></a>
                                        </div>
                                    </div>
                                </div>
                            </div>
