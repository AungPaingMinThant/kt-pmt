					...
					<div class="col-md-8">
						<div id="scroll_content" data-spy="scroll" data-target="#myScrollspy" data-offset="10" style="">
							...
							<div class="row d-none" id="championing_human_rights">
								...
								<img src="{{ url('/images/about-aya/sustainability/social_for_employee.webp') }}" class="img-fluid social_sustainability_icon">
								<p class="mb-10 fw-semibold">For Employees</p>
								...
								<p class="mb-10 fw-semibold">For Customers</p>
								...
								<p class="mb-10 fw-semibold">For Community</p>
							...
							<div class="row d-none" id="business_ethics">
								...
								<div class="row">
									<p>Ethics form the bedrock of societal functioning. We firmly believe that our business ethics guide our employees' behavior. We have demonstrated our commitment to conducting business in an upright manner. The Bank has implemented an <b>ethical code of conduct</b> to foster integrity among our key stakeholders, such as employees, investors, and consumers, and continues to cultivate this culture. It's vital that our employees are committed to making ethical decisions.</p>
