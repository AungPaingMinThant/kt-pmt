						...
						<div id="scroll_content" data-spy="scroll" data-target="#myScrollspy" data-offset="10" style="">
							...
							<div class="row" id="leading_charge_green_financing">
								...
								<div class="row">
									...
									<p><a href="{{ url('file/environmental-substainability/Green-Financing.pdf') }}">Click here</a>&nbsp;to find more on our green financing efforts which align lending and environmental objectives.
								</div>
							</div>
