				...
				<div class="container">
					...
					<div class="row">
						...
						<div class="col-md-12">
							...
							<p>In 2020, we celebrated our tenth anniversary. These first ten years represent years of growth and extraordinary results which have allowed us to secure a top position in the banking sector. Our Bank has 262 branches across the country, reflected in the lives of 6200 staff members and over three million customers.</p>
							...
							<p class="mb-0">
								<a class="theme_text_color" href="{{ url('/about-aya/governance/corporate-governance#board_committees') }}">Meet Our Leaders <i class="bx bx-chevron-right" style="font-size: 18px;line-height: 18px;"></i></a>
							</p>
						</div>
						<div class="space-40"></div>
					</div>
