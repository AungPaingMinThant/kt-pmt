			...
			<div>
				<div class="container">
					...
					<div class="row past_annual_report_row">
						...
						<div class="col-md-4 annual_report_2" style="background-color: #fafafa;display: none;">
					...
					<div class="row past_annual_report_row">
						<div class="col-md-4" style="background-color: #fafafa;">
							...
							<p class="download_report" onclick="reportModal('Annual General Meeting - AGM (Myanmar Version) FY 2019 – 2020', 'FY2019_2020_AGM_Notice_Myanmar_Version.pdf','2')" data-bs-toggle="modal" data-bs-target="#report_download_modal"><img src="{{ url('/images/about-aya/report/download.png') }}" class="img-fluid view_online_icon"> Download Annual Report</p>
						</div>
						<div class="col-md-4" style="background-color: #fafafa;">
							...
							<p class="download_report" onclick="reportModal('Annual General Meeting - AGM (English Version) FY 2019 – 2020', 'FY2019_2020_AGM_Notice_English_Version.pdf','2')" data-bs-toggle="modal" data-bs-target="#report_download_modal"><img src="{{ url('/images/about-aya/report/download.png') }}" class="img-fluid view_online_icon"> Download Annual Report</p>
						</div>
						<div class="col-md-4" style="background-color: #fafafa;">
							...
							<p class="download_report" onclick="reportModal('Annual General Meeting - AGM (Myanmar Version) FY 2018 – 2019', 'FY2018_2019_AGM_Notice_Myanmar_Version.pdf','2')" data-bs-toggle="modal" data-bs-target="#report_download_modal"><img src="{{ url('/images/about-aya/report/download.png') }}" class="img-fluid view_online_icon"> Download Annual Report</p>
						</div>
						<div class="col-md-4 meeting_notice_2" style="background-color: #fafafa; display: none;">
							...
							<p class="download_report" onclick="reportModal('Annual General Meeting - AGM (English Version) FY 2018 – 2019', 'FY2018_2019_AGM_Notice_English_Version.pdf','2')" data-bs-toggle="modal" data-bs-target="#report_download_modal"><img src="{{ url('/images/about-aya/report/download.png') }}" class="img-fluid view_online_icon"> Download Annual Report</p>
						</div>
					...
					<div class="row past_annual_report_row">
						<div class="col-md-4" style="background-color: #fafafa;">
							...
							<p class="download_report" onclick="reportModal('Financial Year Annual General Meeting (English Version) Minutes of 2019 – 2020', 'FY2019_2020_AGM_minutes_Myanmar_Version.pdf','3')" data-bs-toggle="modal" data-bs-target="#report_download_modal"><img src="{{ url('/images/about-aya/report/download.png') }}" class="img-fluid view_online_icon"> Download Annual Report</p>
						</div>
						<div class="col-md-4" style="background-color: #fafafa;">
							...
							<p class="download_report" onclick="reportModal('Financial Year Annual General Meeting (English Version) Minutes of 2019 – 2020', 'FY2019_2020_AGM_minutes_English_Version.pdf','3')" data-bs-toggle="modal" data-bs-target="#report_download_modal"><img src="{{ url('/images/about-aya/report/download.png') }}" class="img-fluid view_online_icon"> Download Annual Report</p>
						</div>
						<div class="col-md-4" style="background-color: #fafafa;">
							...
							<p class="download_report" onclick="reportModal('Financial Year Annual General Meeting (Myanmar Version) Minutes of 2018 – 2018', 'FY2018_2019_AGM_minutes_Myanmar_Version.pdf','3')" data-bs-toggle="modal" data-bs-target="#report_download_modal"><img src="{{ url('/images/about-aya/report/download.png') }}" class="img-fluid view_online_icon"> Download Annual Report</p>
						</div>
						<div class="col-md-4 meeting_minute_2" style="background-color: #fafafa; display: none;">
							...
							<p class="download_report" onclick="reportModal('Financial Year Annual General Meeting (English Version) Minutes of 2018 – 2018', 'FY2018_2019_AGM_minutes_English_Version.pdf','3')" data-bs-toggle="modal" data-bs-target="#report_download_modal"><img src="{{ url('/images/about-aya/report/download.png') }}" class="img-fluid view_online_icon"> Download Annual Report</p>
						</div>
