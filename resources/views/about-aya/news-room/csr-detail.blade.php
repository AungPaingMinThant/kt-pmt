...
@section('title', 'CSR News – AYA Bank')
...
<div class="layout-wrapper layout-content-navbar">
   	<div class="layout-container">
		<div class="layout-page">
			...
			@include('layouts.banner', ['page'=>'csr_news'])
					...
					<div class="col-md-3">
						<div class="row pl-1">
							...
							@foreach($yearList as $y_list)
								<p>
									<a href="{{ url('/about-aya/news-room/csr-news/year/'.$y_list->publish_year) }}" class="f-body-color year_link">{{ $y_list->publish_year }}</a>
								</p>
							@endforeach
						</div>
						...
						<div class="row pl-1">
							<?php
								$related = App\Models\Blog::where('id','!=',$blog->id)->where('blog_category',9)->where('status','0')->orderBy('publish_date', 'desc')->limit(3)->get();
							?>
							@if(count($related) > 0)
							...
							@foreach($related as $rel)
								<div class="row">
									<div class="news_title_div">
										<a class="news_title_link" href="{{ url('/about-aya/news-room/csr-news/'.$rel->permalink) }}">
