...
@section('title', 'Press Release – AYA Bank')
...
<div class="layout-wrapper layout-content-navbar">
   	<div class="layout-container">
		<div class="layout-page">
			...
			@include('layouts.banner', ['page'=>'press_release','news_year'=>$news_year])
						...
						<div class="row">
							@foreach($blog_list as $b_list)
								<div class="news_blog col-md-4 mb-4">
									<div class="row news_img_div" style="background-image: url('{{ url("/public/".$b_list->featured_image) }}');border-top: 1px solid #f1f1f1;border-left: 1px solid #f1f1f1;border-right: 1px solid #f1f1f1;">
										<!-- <img src="{{ url($b_list->featured_image) }}" class="img-fluid"> -->
									</div>
									<div class="news_content_div" style="border: 1px solid #f1f1f1;">
										<div class="news_title_div">
											<a href="{{ url('/about-aya/news-room/press-release/'.$b_list->permalink) }}" class="news_title_link">
					...
					<div class="col-md-3">
						<div class="row pl-1">
							...
							@foreach($yearList as $y_list)
								<p>
									<a href="{{ url('/about-aya/news-room/press-release/year/'.$y_list->publish_year) }}" class="f-body-color year_link">{{ $y_list->publish_year }}</a>
								</p>
							@endforeach
						</div>
