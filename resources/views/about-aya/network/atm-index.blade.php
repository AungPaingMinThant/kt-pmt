										...
										<table class="table table-borderless">
											<thead>
												<tr valign="middle">
													...
													<td class="py-3 f-white" style="font-size: 12px;width: 4%;background-color: #fb7e1c;">Township</td>
													<td class="py-3 f-white" style="font-size: 12px;width: 10%;background-color: #f04223;">Location Names</td>
