				...
				<div class="container">
					...
					<div class="row for_community_CTA">
						...
						<div class="col-md-6">
							...
							<img src="{{ url('/images/about-aya/corporate-goals/corporate_social_responsibility.webp') }}" class="img-fluid">
				...
				<div class="container">
					...
					<div class="row for_staff_CTA">
						...
						<div class="col-md-6">
							...
							<img src="{{ url('/images/about-aya/corporate-goals/emp_development.webp') }}" class="img-fluid">
