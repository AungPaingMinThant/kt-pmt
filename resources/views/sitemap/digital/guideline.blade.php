                    ...
                    <div class="row">
                        <div class="col-md-4 px-3 mb-40">
                            <div class="card h-100 sitemap_card">
                                <img class="card-img-top" src="{{ url('/images/digital_secure/mobile_KV.jpg') }}" alt="Card image cap" />
                                <div class="card-body">
                        ...
                        <div class="col-md-4 px-3 mb-40">
                            <div class="card h-100 sitemap_card">
                                <img class="card-img-top" src="{{ url('/images/frequently/mobile_KV.jpg') }}" alt="Card image cap" />
                                <div class="card-body">
