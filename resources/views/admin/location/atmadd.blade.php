	...
	<div class="layout-wrapper layout-content-navbar">
	   	<div class="layout-container">
			...
			<div class="layout-page">
				@include('layouts.nav', ['nav'=>'Add ATM Locations', 'page'=>'Location'])
					...
					<div class="container-xxl flex-grow-1 container-p-y">
						<div class="row">
							<div class="col-xl">
								<div class="card mb-4">
									<div class="card-body">
										<form class="mb-3" action="{{ url('admin/location/atm-location') }}" method="POST" id="blog_form" enctype="multipart/form-data" >
											{{ csrf_field() }}
