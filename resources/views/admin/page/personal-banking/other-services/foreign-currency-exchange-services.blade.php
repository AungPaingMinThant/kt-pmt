...
@section('title', 'Foreign Currency Exchages – AYA Bank')
...
<div class="layout-wrapper layout-content-navbar">
   	<div class="layout-container">
		<div class="layout-page">
			@include('layouts.nav', ['nav'=>'Foreign Currency Exchages', 'page'=>'foreign_currency_exchange'])
        	<br>
			@include('layouts.admin_banner', ['page'=>'foreign_currency_exchange'])

			<div class="container section_1" >
				@include('layouts.admin_tagline', ['page'=>'foreign_currency_exchange'])
			</div>
...
<!-- Modal -->
<div class="modal fade" id="section_special_purpose_modal" data-bs-backdrop="static" tabindex="-1">
	<div class="modal-dialog modal-dialog-centered modal-xl modal-dialog-scrollable">
		<form class="modal-content" action="{{ url('/admin/foreign-currency-exchange-service/special/update') }}" method="POST" enctype="multipart/form-data">
					...
					<div class="col-md-12">
						<div class="mb-3 row">
							...
							<div class="col-md-12" style="margin-bottom: 10px;">
								...
								<input type="text" class="form-control" id="section_title" name="section_title" value="{{ $page_data->section_title }}">
								
								<div class="space-20"></div>
								
								<label for="section_desc" class="col-form-label">Section Information</label>
								<textarea class="form-control" id="section_desc" name="section_desc" rows="10" spellcheck="false" >{!! htmlspecialchars_decode($page_data->section_desc) !!}</textarea>
							</div>
...
<div class="modal fade" id="section_disclaimer_modal" data-bs-backdrop="static" tabindex="-1">
	<div class="modal-dialog modal-dialog-centered modal-xl modal-dialog-scrollable">
		<form class="modal-content" action="{{ url('/admin/foreign-currency-exchange-service/disclaimer/update') }}" method="POST" enctype="multipart/form-data">
			<div class="modal-header">					
				<button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
			</div>
			<div class="modal-body" style="padding: 0px 40px;">
				...
				<div class="row" style="margin-bottom: 20px;">
					<div class="col-md-12">
						<div class="mb-3 row">
							<h4>Disclaimer Section Update</h4>
							<div class="col-md-12" style="margin-bottom: 10px;">
								<label for="disclaimer_title" class="col-form-label">Disclaimer Title</label>
								<input type="text" class="form-control" id="disclaimer_title" name="disclaimer_title" value="{{ $page_data->disclaimer_title }}">
								
								<div class="space-20"></div>
								
								<label for="disclaimer_desc" class="col-form-label">Disclaimer Information</label>
								<textarea class="form-control" id="disclaimer_desc" name="disclaimer_desc" rows="10" spellcheck="false" >{!! htmlspecialchars_decode($page_data->disclaimer_desc) !!}</textarea>
							</div>
