...
<div class="layout-wrapper layout-content-navbar">
   	<div class="layout-container">
		<div class="layout-page">
			...
			@include('layouts.banner', ['page'=>'aya_maximizer_saving'])
						...
						<div class="col-md-8">
							...
							<div class="row">
								<div class="col-md-6" style="margin-bottom: 20px;">
									<img src="{{ url('/images/acc_saving/aya-maximizer-saving/benefit_icon_1.png') }}" class="img-fluid" style="width: 17%;">
									<p>Bonus is rewarded upon maintaining the minimum balance of MMK 100,000 every month and a minimum deposit of MMK 10,000 every month</p>
								</div>
								<div class="col-md-6" style="margin-bottom: 20px;">
									<img src="{{ url('/images/acc_saving/aya-maximizer-saving/benefit_icon_2.png') }}" class="img-fluid" style="width: 17%;">
									<p>Receive interest 6.0 % per annum and bonus 0.25% per annum</p>
								</div>
								<div class="col-md-6" style="margin-bottom: 20px;">
									<img src="{{ url('/images/acc_saving/aya-maximizer-saving/benefit_icon_3.png') }}" class="img-fluid" style="width: 17%;">
											...
											<div class="accordion-item">
												<h2 class="accordion-header" id="headingOne">
													<button class="accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#collapseOne" aria-expanded="true" aria-controls="collapseOne">
														What is the initial deposit amount to open Saving Interest Maximizer Account and its inerest rate?
													</button>
												</h2>
												<div id="collapseOne" class="accordion-collapse collapse" aria-labelledby="headingOne" data-bs-parent="#accordionExample">
													<div class="accordion-body">
														<p>Minimum initial deposit is MMK 100,000 and interest is 6% per annum.</p>
													</div>
												</div>
											</div>
											<div class="accordion-item">
												<h2 class="accordion-header" id="headingTwo">
													<button class="accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#collapseTwo" aria-expanded="false" aria-controls="collapseTwo">
														How much bonus do I Saving Interest Maximizer Account provide?
													</button>
												</h2>
												<div id="collapseTwo" class="accordion-collapse collapse" aria-labelledby="headingTwo" data-bs-parent="#accordionExample">
													<div class="accordion-body">
														<p>Bonus is 0.25% per annum.</p>
													</div>
												</div>
											</div>
										</div>
