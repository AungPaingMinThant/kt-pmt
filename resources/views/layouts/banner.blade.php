			...
			<div class="row d-none d-sm-block">
				<div class="col-md-6 text-right" style="text-align: right;position: relative;">
					<div style="position: absolute;top: 156px;right: 0;">
						<p style="font-size: 26px;font-weight: 400;margin-bottom: 0;line-height: 36px;"><span style="color: #a02226;">In touch</span> with your bank account</p>
						<p style="font-size: 26px;font-weight: 400;margin-bottom: 0;line-height: 28px;">
	...
	<div class="prepaid_banner banner_bg" style="">
		<div class="container">
			...
			<div class="row d-block d-sm-none">
				<div class="col-md-12 text-left" style="text-align: left;position: relative;">
					<div style="position: absolute;top: 45px;left: 25px;">
						<p style="font-size: 18px;font-weight: 400;margin-bottom: 0;line-height: 20px;">Pick AYA World Travel Card,<br><span style="color: #a02226;">explore the world and make life more fun!</span></p>
...
@if($page == 'currentdeposit')
	<div class="currentdeposit_banner banner_bg" style="">
		<div class="container">
			<div class="row d-none d-sm-block">
				<div class="col-md-6 text-left" style="text-align: left;position: relative;">
					<div class="call_deposit_banner_tagline">
						<p style="font-size: 26px;font-weight: 400;margin-bottom: 0;line-height: 36px;"><span style="color: #a02226;">Make your everyday</span> banking<br><span style="color: #a02226;">easy and access</span> funds anytime</p>
					</div>
				</div>
				<div class="col-md-6" style="text-align: right;">
					<p></p>
...
@if($page == 'fixed_deposit')
	<div class="fixed_deposit_banner banner_bg" style="">
		<div class="container">
			<div class="row d-none d-sm-block">
				<div class="col-md-6 text-left" style="text-align: left;position: relative;">
					<div class="fixed_deposit_banner_tagline">
						<p style="font-size: 26px;font-weight: 400;margin-bottom: 0;line-height: 36px;">Maximise savings with<br><span style="color: #a02226;">AYA Fixed Deposits</span></p>
					</div>
				</div>
				<div class="col-md-6" style="text-align: right;">
					<p></p>
...
@if($page == 'remittance_local')
	<div class="remittance_local_banner banner_bg" style="">
		<div class="container">
			<div class="row d-none d-sm-block">
				<div class="col-md-6 text-left" style="text-align: left;position: relative;">
					<div class="tag_line_div" style="">
			...
			<div class="row d-block d-sm-none">
				<div class="col-md-12 text-left" style="text-align: left;position: relative;">
					<div style="position: absolute;top: 45px;left: 25px;">
						<p style="font-size: 20px;font-weight: 400;margin-bottom: 0;line-height: 22px;"><span style="color: #a02226;">Send or receive money securely & instantly</span> anywhere in Myanmar at AYA Branches</p>
					</div>
				</div>
			</div>
		</div>
...
@if($page == 'remittance_inter')
	<div class="remittance_inter_banner banner_bg" style="">
		<div class="container">
			<div class="row d-none d-sm-block">
				<div class="col-md-6 text-left" style="text-align: left;position: relative;">
...
@if($page == 'autoloan')
	<div class="autoloan_banner banner_bg" style="">
		<div class="container">
			<div class="row d-none d-sm-block">
				<div class="col-md-4 text-left" style="text-align: left;position: relative;">
					<div class="autoloan_banner_tagline">
						<p style="font-size: 26px;font-weight: 400;margin-bottom: 0;line-height: 36px;"><span style="color: #a02226;">Own your dream car </span>with AYA Auto Loan</p>
					</div>
				</div>
				<div class="col-md-6" style="text-align: right;">
					<p></p>
...
@if($page == 'c2cautoloan')
	<div class="c2c_autoloan_banner banner_bg" style="">
		<div class="container">
			<div class="row d-none d-sm-block">
				<div class="col-md-6 text-left" style="text-align: left;position: relative;">
			...
			<div class="row d-block d-sm-none">
				<div class="col-md-12 text-left" style="text-align: left;position: relative;">
					<div style="position: absolute;top: 30px;left: 25px;">
						<p style="font-size: 18px;font-weight: 400;margin-bottom: 0;line-height: 20px;">Driving a better customer experience, financing for<span style="color: #a02226;"> auto purchases from any private seller</span></p>
					</div>
				</div>
			</div>
		</div>
...
@if($page == 'foreign_currency_exchange')
	<div class="foreign_currency_exchange_banner banner_bg" style="">
		<div class="container">
			<div class="row d-none d-sm-block">
				<div class="col-md-6 text-left" style="text-align: left;position: relative;">
					<div class="foreign_currency_exchange_banner_tagline">
						<p style="font-size: 26px;font-weight: 400;margin-bottom: 0;line-height: 36px;"><span style="color: #a02226;">Buy and sell foreign currencies</span> at AYA Currency Exchange</p>
					</div>
				</div>
				<div class="col-md-6" style="text-align: right;">
					<p></p>
			...
			<div class="row d-block d-sm-none">
				<div class="col-md-12 text-left" style="text-align: left;position: relative;">
					<div style="position: absolute;top: 30px;left: 25px;">
						<p style="font-size: 18px;font-weight: 400;margin-bottom: 0;line-height: 20px;"><span style="color: #a02226;">Buy and sell foreign currencies</span><br>at AYA Currency Exchange</p>
					</div>
				</div>
			</div>
		</div>
...
@if($page == 'safe_deposit')
	<div class="safe_deposit_banner banner_bg" style="">
		<div class="container">
			<div class="row d-none d-sm-block">
				<div class="col-md-6 text-left" style="text-align: left;position: relative;">
					<div class="safe_deposit_banner_tagline">
						<p style="font-size: 26px;font-weight: 400;margin-bottom: 0;line-height: 36px;">Keep your valuables and documents safe</p>
					</div>
				</div>
				<div class="col-md-6" style="text-align: right;">
					<p></p>
...
@if($page == 'bu_acc_sav_saving_deposit')
	<div class="bu_acc_sav_saving_deposit_banner banner_bg" style="">
		<div class="container">
			<div class="row d-none d-sm-block">
				<div class="col-md-6 text-left" style="text-align: left;position: relative;">
...
@if($page == 'bu_acc_sav_current_deposit')
	<div class="bu_acc_sav_current_deposit_banner banner_bg" style="">
		<div class="container">
			<div class="row d-none d-sm-block">
				<div class="col-md-6 text-left" style="text-align: left;position: relative;">
...
@if($page == 'bu_acc_sav_fixed_deposit')
	<div class="bu_acc_sav_fixed_deposit_banner banner_bg" style="">
		<div class="container">
			<div class="row d-none d-sm-block">
				<div class="col-md-6 text-left" style="text-align: left;position: relative;">
					<div class="bu_acc_sav_fixed_deposit_banner_tagline">
						<p style="font-size: 26px;font-weight: 400;margin-bottom: 0;line-height: 36px;"><span class="theme_text_color">Earn highest interest</span><br>and maximize returns for your business</p>
					</div>
				</div>
				<div class="col-md-6" style="text-align: right;">
					<p></p>
			...
			<div class="row d-block d-sm-none">
				<div class="col-md-12 text-left" style="text-align: left;position: relative;">
					<div style="position: absolute;top: 50px;left: 150px;right: 20px;background-color: #ffffff96;padding: 20px;">
						<p style="font-size: 18px;font-weight: 400;margin-bottom: 0;line-height: 20px;"><span class="theme_text_color">Earn highest interest</span><br>and maximize returns for your business</p>
					</div>
				</div>
			</div>
		</div>
